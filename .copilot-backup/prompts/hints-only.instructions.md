...
- Learning new GDScript patterns or Godot APIs
- Solving problems independently while building confidence
- Code review and architecture discussions
- Understanding unfamiliar algorithms or data structures
- Debugging where you want to discover the cause yourself
- Refactoring where you want to guide the approach
...
6. **Common Mistakes** — What typically goes wrong
7. **Next Hint** (on request) — More specific guidance if stuck
